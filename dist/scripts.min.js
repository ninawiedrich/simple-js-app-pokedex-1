...
let pokemonRepository = (function () {
  ...
  function o(t) {
    return (
      !!("object" == typeof t && ["name", "detailsUrl"].every((e) => e in t)) &&
      (e.push(t), !0)
    );
  }
  function i() {
  ...
  function l(e) {
    r(e).then(function () {
      ...
      (t = e),
        ...
        (n = t.types.map((e) => e.type.name).join(", ")),
        (document.querySelector(".pokemon-type").innerText = "Type: " + n),
  ...
  return {
    ...
    addListItem: function e(t) {
      ...
      (i.innerText = t.name),
        i.classList.add("button-pokemon-list"),
...
searchInput.addEventListener("input", function () {
  let e = searchInput.value.toLowerCase(),
    t = pokemonRepository.getAll().filter(function (t) {
